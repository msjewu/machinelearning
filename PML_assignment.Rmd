...
```
##Step 2. Create training and validation sets - name them 'train' and 'validation.'
```{r}
set.seed(123)
...
```
##Conclusion
Our preferred method to model the data is random forests, which provides an accuracy of 99.2% when tested on the validation set.  This means the out-of-sample error would be less than 1%.